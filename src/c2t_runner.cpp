...
template <> struct pimpl_impl<local_ai::c2t_runner> : pimpl_impl_base
{
...
c2t_runner::c2t_runner(const std::filesystem::path& model_data_path) : with_pimpl(model_data_path)
{
}
